...
import com.jxkj.readapp.bean.CityModel;
import com.jxkj.readapp.bean.DistrictModel;
import com.jxkj.readapp.bean.ProvinceModel;
...
public class XmlParserHandler extends DefaultHandler {
	...
	public void startElement(String uri, String localName, String qName,
		...
		if (qName.equals("province")) {
			...
			districtModel.setDistrictId(attributes.getValue(0));
