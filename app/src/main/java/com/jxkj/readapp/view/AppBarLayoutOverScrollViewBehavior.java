...
public class AppBarLayoutOverScrollViewBehavior extends AppBarLayout.Behavior {
    private static final String TAG = "search";//图片
    ...
    private View mTargetView;//图片
    private int mParentHeight;//toolbar的高度
    private int mTargetViewHeight;//图片高度
    ...
    private int mMiddleHeight;//个人信息高度
...
//        }
        ...
        // 需要在调用过super.onLayoutChild()方法之后获取,现在获取的是搜索标题栏
        if (mTargetView == null) {
